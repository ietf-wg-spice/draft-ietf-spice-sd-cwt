...
- the hash algorithm in the `sd_alg` claim is supported by the Holder;
...
The SD-KBT contains the SD-CWT, including the Holder's choice of presented disclosures, in the `issuer_sd_cwt` claim in the SD-KBT payload.
...
* Claim Name: issuer_sd_cwt
* Claim Description: The issuer-signed SD-CWT, including Hodler-selected disclosures
* JWT Claim Name: N/A
