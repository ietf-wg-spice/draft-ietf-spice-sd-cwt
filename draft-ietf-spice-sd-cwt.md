...
When encrypted disclosures are present, the corresponding plaintext disclosures MUST be in the unprotected headers of the Issuer-signed SD-CWT, before the SD-KBT can be generated by the Holder.
